/**
 * Single Source of Truth Supabase initialization.
 *
 * Exports an async-ready shared Supabase client and helpers.
 */

// Config
const supabaseUrl = 'https://dtucddjjuexgkxpuohmd.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR0dWNkZGpqdWV4Z2t4cHVvaG1kIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQ2OTczNTAsImV4cCI6MjA5MDI3MzM1MH0.lCiCBgetXeJwfLRSGw0seTIoEnQIOegKf7PrQrxQ_Mk';
...
// Main client promise
const supabasePromise = loadSupabaseCDN()
  .then((client) => {
